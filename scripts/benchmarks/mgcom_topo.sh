...
REPR_DIM=64
#EXPERIMENT="$ARGS_CMD/mgcom_topo_executor.py --experiment=benchmark_mgtcom_feat $ARGS_BASE --lr=0.005 --num_workers=3 --metric=DOTP"
EXPERIMENT="$ARGS_CMD/mgcom_topo_executor.py --experiment=benchmark_mgtcom_topo $ARGS_BASE --lr=0.02 --repr_dim=$REPR_DIM --num_workers=3 --metric=DOTP"
#EXPERIMENT="$ARGS_CMD/mgcom_topo_executor.py --experiment=benchmark_mgtcom_feat $ARGS_BASE --lr=0.005 --repr_dim=64 --num_workers=3 --metric=DOTP"
