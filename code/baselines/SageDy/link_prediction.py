...
def evaluate_classifier(train_pos, train_neg, val_pos, val_neg, test_pos, test_neg, source_embeds, target_embeds):
    ...
    for operator in operatorTypes:
        ...
        test_roc_score = roc_auc_score(test_labels, test_predict, average = matries)
        val_roc_score = roc_auc_score(val_labels, val_predict, average = matries)
...
def get_roc_score_t(edges_pos, edges_neg, source_emb, target_emb):
    ...
    roc_score = roc_auc_score(labels_all, pred_all, average = matries)
    return roc_score
