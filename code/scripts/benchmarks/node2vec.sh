...
ARGS_SDS="--batch_size=1024 --max_epochs=20 --dataset=SocialDistancingStudents --embedding_visualizer.dim_reduction_mode=TSNE --embedding_visualizer.interval=10 --classification_eval.interval=10"

ARGS_DS="$ARGS_DBLP"

EXPERIMENT="$ARGS_CMD/baselines/het2vec_executor.py --experiment=baseline_node2vec $ARGS_BASE $ARGS_DS --num_workers=3 --metric=DOTP --infer_k=20 --loss=SKIPGRAM --lr=0.04"
