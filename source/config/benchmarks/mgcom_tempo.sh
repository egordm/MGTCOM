...
ARGS_SDS="--batch_size=1024 --max_epochs=30 --dataset=SocialDistancingStudents --embedding_visualizer.dim_reduction_mode=TSNE --embedding_visualizer.interval=10 --classification_eval.interval=10"
...
REPR_DIM=64
EXPERIMENT="$ARGS_CMD/mgcom_tempo_executor.py --experiment=benchmark_mgtcom_tempo $ARGS_BASE --lr=0.02 --repr_dim=$REPR_DIM --num_workers=3 --metric=DOTP"
